...
namespace HomeRental.DAL
{
    public class ApplicationInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<ApplicationDbContext>
    {
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            {
                new Rental{ID=1,Capacity=2,PricePerNight=80,Address="chemin de putdael",number=12,PostalCode=1160,City="Auderghem",Country="Belgium",Longitude=null, Latitude=null},
                new Rental{ID=2,Capacity=1,PricePerNight=60,Address="rue Auguste Orts",number=25,PostalCode=1000,City="Bruxelles",Country="Belgium",Longitude=null, Latitude=null},
                new Rental{ID=3,Capacity=2,PricePerNight=120,Address="Corniche Verte",number=9,PostalCode=1150,City="Woluwe-Saint-Pierre",Country="Belgium",Longitude=null, Latitude=null},
            };
